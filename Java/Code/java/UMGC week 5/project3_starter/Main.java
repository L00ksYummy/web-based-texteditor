 ...
 * 6/22/2024
 * This file holds the main class that is used to run the methods in CompleteBinaryTree.java
 * it holds the test cases for the previous file to makes sure everything runs right. 
 */
