 ...
 * 6/22/2024
 * This is the bulk of the project that contains the methods for the main class
 * This file holds the tree nodes, creation of the trees, one taking an int array and one taking a string,
 * a method that uses preorder traversal to print the tree structure, a method to check if the tree is a max heap or a 
 * binary search tree, and a method to print an in order list of the tree from smallest to largest. 
 * Most methods use recursion
 */
